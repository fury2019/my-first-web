...
<body>
  ...
  <div class="container">
      ...
      <div class="room-type">
          <h2>멤버스 라운지</h2>
          <div class="room">
              <img src="../Facilities_image/라운지_멤버스라운지_서울.png" alt="라운지_멤버스라운지_서울" class="room-image">
              <div class="room-info">
                  <h3>멤버스 라운지</h3>
...
<div id="myModal1" class="modal">
    <div class="modal-content">
     <span class="close" onclick="closeModal('myModal1')">&times;</span>
      <img class="modal-image" id="modalImage1" src="../Facilities_image/라운지_멤버스라운지_서울.png" alt="슬라이드쇼 이미지">
       <span class="prev" onclick="plusSlides(-1, 'myModal1')">&#10094;</span>
       <span class="next" onclick="plusSlides(1, 'myModal1')">&#10095;</span>
        <div class="thumbnail-container">
         	<img class="thumbnail" src="../Facilities_image/라운지_멤버스라운지_서울.png" onclick="currentSlide(1, 'myModal1')">
        </div>
    </div>
</div>
...
function showSlides(n, modalId) {
	var images = {
			'myModal1': ["../Facilities_image/라운지_멤버스라운지_서울.png"]
