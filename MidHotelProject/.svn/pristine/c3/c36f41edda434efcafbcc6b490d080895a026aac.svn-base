...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>베딩 세트_S</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">1,200,000원</span></p>
                <p>구성 : 구스다운 이불(S) 1, 이불커버(S) 1, 매트리스커버(S) 1, 베드패드(S) 1</p>
            ...
            <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">1,200,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Ls001"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="베딩 세트_S"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="1200000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>베딩 세트(Single size)</h3>
        <br>
        <p>구스다운 이불 1개,이불커버 1개,매트리스커버 1개,베드패드 1개</p>
        <br>
        <p>이불은 헝가리산 구스를 사용하여 제작되었습니다.</p>
        <p>헝가리 구스는 발트해의 차가운 해풍과 급격한 기후변화에 적응하기 위해 가슴 솜털이 발달하였으며,</p>
        <p>솜털 사이에 수많은 공기층이 형성되여 쾌적한 수면환경을 조성하는 최상의 소재입니다.</p>
        <br>
        <br>
        <div class="detail-item">
        <img src="../../image/상세 베딩 세트_S.JPG" alt="베딩 세트_S">
    </div>
</div>

<script>
    const unitPrice = 1200000; // 단가
