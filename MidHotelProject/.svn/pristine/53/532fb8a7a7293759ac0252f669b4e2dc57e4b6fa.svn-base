 ...
 <div class="header">
    ...
    <div class="container">
        <div class="category-header">
            ...
            <h2 class="category-title">과일 (6)</h2>
        </div>
    
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Fruit_E-SHOP/1.jsp">
                <img src="image/과일혼합 1호.jpg" alt="과일혼합 1호">
                <div class="product-name">과일혼합 1호</div>
                <div class="product-price">150,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Fruit_E-SHOP/2.jsp">
                <img src="image/과일혼합 2호.jpg" alt="과일혼합 2호">
                <div class="product-name">과일혼합 2호</div>
                <div class="product-price">200,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Fruit_E-SHOP/3.jsp">
                <img src="image/과일혼합 3호.jpg" alt="과일혼합 3호">
                <div class="product-name">과일혼합 3호</div>
                <div class="product-price">250,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Fruit_E-SHOP/4.jsp">
                <img src="image/과일혼합 4호.jpg" alt="과일혼합 4호">
                <div class="product-name">과일혼합 4호</div>
                <div class="product-price">300,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Fruit_E-SHOP/5.jsp">
                <img src="image/과일혼합 5호.jpg" alt="과일혼합 5호">
                <div class="product-name">과일혼합 5호</div>
                <div class="product-price">350,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Fruit_E-SHOP/6.jsp">
                <img src="image/과일혼합 6호.jpg" alt="과일혼합 6호">
                <div class="product-name">과일혼합 6호</div>
