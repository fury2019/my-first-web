...
<body>
    <div class="container">
        <h2>공지사항 새글 등록</h2>
        <form action="<%=request.getContextPath()%>/noticeInsert" method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="notice_content" name="notice_content" rows="3" placeholder="공지사항 내용을 입력하세요." required></textarea>
            </div>
            <div class="form-group">
