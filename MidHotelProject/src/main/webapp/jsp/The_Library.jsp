...
<body>
  ...
  <div class="container">
      ...
      <div class="room-type">
          <h2>더 라이브러리</h2>
          <div class="room">
              <img src="../Facilities_image/바_더라이브러리_서울.png" alt="더 라이브러리" class="room-image">
              <div class="room-info">
                  <h3>더 라이브러리</h3>
      ...
      <img class="modal-image" id="modalImage1" src="../Facilities_image/바_더라이브러리_서울.png" alt="슬라이드쇼 이미지">
       ...
       <span class="next" onclick="plusSlides(1, 'myModal1')">&#10095;</span>
        <div class="thumbnail-container">
         	<img class="thumbnail" src="../Facilities_image/바_더라이브러리_서울.png" onclick="currentSlide(1, 'myModal1')">
        </div>
    </div>
</div>
...
function showSlides(n, modalId) {
	var images = {
			'myModal1': ["../Facilities_image/바_더라이브러리_서울.png"]
