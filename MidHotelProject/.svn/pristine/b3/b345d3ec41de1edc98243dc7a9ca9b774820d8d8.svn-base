...
<div class="header">
    ...
    <div class="container">
        <div class="category-header">
            <img src="../image/린넨.jpg" alt="린넨" style="width: 100%; height: auto; border-radius: 5px;">
            <h2 class="category-title">린넨 (3)</h2>
        </div>
    
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Linen_E-SHOP/1.jsp">
                <img src="../image/타월 세트.jpg" alt="타월 세트">
                <div class="product-name">타월 세트</div>
                <div class="product-price">300,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Linen_E-SHOP/2.jsp">
                <img src="../image/배스로브 세트.jpg" alt="배스로브 세트">
                <div class="product-name">배스로브 세트</div>
                <div class="product-price">400,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Linen_E-SHOP/3.jsp">
                <img src="../image/배스로브 & 타월 세트.jpg" alt="배스로브 & 타월 세트">
                <div class="product-name">배스로브 & 타월 세트</div>
