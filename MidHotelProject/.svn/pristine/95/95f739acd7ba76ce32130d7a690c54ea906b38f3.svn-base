...
.detail-item img {
    ...
    <body>
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
         ...
         <img src="../../image/수복강녕 진액 1.jpg" alt="수복강녕 진액 1">
          </div>
        <div class="product-info">
           ...
           <div class="total"> 총 금액: <span class="total-price" id="total-price">250,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo022"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="수복강녕 진액 1"> <!-- 상품 이름 추가 -->
