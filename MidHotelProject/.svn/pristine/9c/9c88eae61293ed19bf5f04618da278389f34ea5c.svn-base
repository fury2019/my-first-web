...
<head>
    ...
    <title>꽃바구니 2. White & Green</title>
...
.detail-item img {
 ...
 <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="details">
             ...
             <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl008"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="꽃바구니 2. White & Green"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>꽃바구니 2. White & Green</h3>
        <br>
        <p>꽃 구성 | 장미,리시얀셔스,카네이션,그린소재 및 기타</p>
        <p>화기 규격 | 33cm(w) x 26cm(d) x 30cm(h)</p>
        <br>
        ...
        <img src="../../image/바구니 2. White & Green.JPG" alt="바구니 2. White & Green">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
