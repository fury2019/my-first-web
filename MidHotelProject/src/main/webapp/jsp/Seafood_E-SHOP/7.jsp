...
.detail-item img {
    ...
    <body>
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>명품 굴비 2호</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">620,000원</span></p>
                <p>구성 : 25cm 이상 10미, 총 1.8kg</p>
                <p>원산지 : 국내산</p>
            ...
            <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">620,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo019"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="명품 굴비 2호"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="620000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>명품 굴비 2호</h3>
        <br>
        <p>25cm 이상의 굴비를 선별하여 총 1.8kg의 신선한 굴비를 제공합니다.</p>
        ...
        <img src="../../image/명품 굴비 2호.JPG" alt="명품 굴비 2호">
    </div>
</div>
</div>
<script>
    const unitPrice = 620000; // 단가
