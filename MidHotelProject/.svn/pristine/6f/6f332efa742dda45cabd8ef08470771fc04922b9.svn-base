...
.detail-item img {
    ...
    <body>
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
         ...
         <img src="../../image/신라 유기농 명차.jpg" alt="신라 유기농 명차.jpg">
          </div>
        <div class="product-info">
            ...
            <div class="total"> 총 금액: <span class="total-price" id="total-price">600,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo025"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="유기농 명차"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>유기농 명차</h3>
        <br>
        <p>보성 녹차의 진수로 불리는 명차는 떫은맛이 적으며</p>
        <p>싱그러운 단맛뿐 아니라 견과류,밤과 같은 고소함과 감칠맛을 느낄 수 있습니다</p>
        <br>
        <div class="detail-item">
        <img src="../../image/유기농 명차.JPG" alt="유기농 명차">
    	</div>
    	<div class="product-details">
        <h2>마시는 방법</h2>
        <br>
        <p>1인 기준 약 2g의 찻잎을 70~80°C정도(찻잔을 손에 쥐었을 때 따끈한 수준)의 물에 2~5분 우려내어 드십시오.</p>
        <p>※어린순으로 만든 고급차일수록 제맛을 내려면 낮은 온도의 물에서 우려내는 것이 좋습니다.</p>
        <p>찻잎이 너무 적으면 싱거우며 너무 많을 경우 쓰고 떫은맛이 강해집니다.</p>
        <br>
</div>
</div>
<script>
