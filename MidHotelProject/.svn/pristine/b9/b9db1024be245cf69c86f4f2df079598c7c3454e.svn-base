...
<form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>베딩 세트_K</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">1,600,000원</span></p>
                <p>구성 : 구스다운 이불(K) 1, 이불커버(K) 1, 매트리스커버(K) 1, 베드패드(K) </p>
            ...
            <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">1,600,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Ls003"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="베딩 세트_K"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="1600000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <img src="../../image/상세 베딩 세트_K.JPG" alt="상세 베딩 세트_K">
    </div>
</div>

<script>
    const unitPrice = 1600000; // 단가
