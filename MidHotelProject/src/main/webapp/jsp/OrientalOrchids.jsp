...
<div class="header">
    ...
    <div class="container">
        <div class="category-header">
            <img src="../image/동양란.jpg" alt="동양란" style="width: 100%; height: auto; border-radius: 5px;">
            <h2 class="category-title">동양란 (4)</h2>
        </div>
    
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/OrientalOrchids_E-SHOP/1.jsp">
                <img src="../image/동양란 태양금.jpg" alt="동양란 태양금">
                <div class="product-name">동양란 태양금</div>
                <div class="product-price">200,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/OrientalOrchids_E-SHOP/2.jsp">
                <img src="../image/동양란 금황.jpg" alt="동양란 금황">
                <div class="product-name">동양란 금황</div>
                <div class="product-price">200,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/OrientalOrchids_E-SHOP/3.jsp">
                <img src="../image/동양란 일향금.jpg" alt="동양란 일향금">
                <div class="product-name">동양란 일향금</div>
                <div class="product-price">250,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/OrientalOrchids_E-SHOP/4.jsp">
                <img src="../image/동양란 황금일향금.jpg" alt="동양란 황금일향금">
                <div class="product-name">동양란 황금일향금</div>
