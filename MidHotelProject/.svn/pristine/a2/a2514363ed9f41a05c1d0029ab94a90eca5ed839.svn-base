    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            <div class="product-image">
                <img src="../../image/서양란 2. Dark Pink.jpg" alt="서양란 1. Dark Pink">
            </div>
            <div class="product-info">
                <h1>서양란 2. Dark Pink</h1>
                <div class="details">
                ...
                <input type="hidden" name="goods_id" value="Fl018"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="서양란 2. Dark Pink"> <!-- 상품 이름 추가 -->
