...
.detail-item p {
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="details">
                ...
                <p>구성 : 실 중량 3.45kg_총 6과_머스크 멜론, 사과, 샤인머스캣 2, 애플 망고, 로얄 망고</p>
                <p>원산지 : 상세설명 참고</p>
             ...
             <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fo007"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="과일 혼합 1호"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <h3>과일 혼합 1호 구성품</h3>
        <p>머스크 멜론 1.3kg, 사과 350g, 샤인머스켓 500g x 2, 애플 망고 400g, 로얄 망고 400g 실 중량 3.45kg</p>
