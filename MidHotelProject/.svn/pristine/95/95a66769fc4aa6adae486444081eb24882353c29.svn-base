...
.detail-item img {
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl005"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="센터피스 3. Coral Pink"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>센터피스 3. Coral Pink</h3>
        <br>
        <p>꽃 구성 | 장미,카네이션,그린소재 및 기타</p>
        <p>화기 규격 | 22cm(w) x 22cm(d) x 20cm(h)</p>
        <br>
        ...
        <img src="../../image/3. Coral Pink.JPG" alt="1. Coral Pink">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
