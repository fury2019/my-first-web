...
<head>
    ...
    <title>센터피스 2. White & Green</title>
...
<form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl004"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="센터피스 2. White & Green"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <img src="../../image/2. White & Green.JPG" alt="2. White & Green">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
