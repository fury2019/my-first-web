...
<head>
    ...
    <title>꽃바구니 3. White & Green</title>
...
.detail-item img {
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>꽃바구니 3. White & Green</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">500,000원</span></p>
                <p>구성 : 장미, 리시얀셔스, 카네이션, 그린소재 및 기타소재</p>
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl010"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="꽃바구니 3. White & Green"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>꽃바구니 3. White & Green</h3>
        <br>
        <p>꽃 구성 | 장미,리시얀셔스,카네이션,그린소재 및 기타</p>
        <p>화기 규격 | 42cm(w) x 28cm(d) x 36cm(h)</p>
        <br>
        <p>풍성하고 자연스러운 느낌을 표현한 디자인의 꽃바구니입니다.</p>
        <p>신선한 꽃으로 구성되며 물을 채운 화기에 꽃을 담아 생생함을 유지합니다.</p>
		<p>'사랑의 맹세'라는 의미를 지닌 꽃 소재로 구성되어 결혼기념일 또는 특별한 날 선물하기 좋은 상품입니다.</p>     
        <br>
        <div class="detail-item">
        <img src="../../image/바구니 3. White & Green.JPG" alt="바구니 3. White & Green">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
