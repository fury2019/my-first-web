...
.detail-item p {
    ...
    <div class="product-section">
        ...
        <div class="product-info">
            <h1>정성한우 일품 1</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">380,000원</span></p>
                <p>구성 : 1+ 구이용 등심 400g, 차돌 400g, 국거리 800g 총 8팩 1.6kg</p>
                <p>원산지 : 국내산 한우 100%</p>
            ...
            <div class="total"> 총 금액: <span class="total-price" id="total-price">380,000원</span> </div>
            <input type="hidden" name="goods_id" value="Fo001"> <!-- 상품 ID 추가 -->
            <input type="hidden" name="goods_name" value="정성한우 일품 1"> <!-- 상품 ID 추가 -->
            <input type="hidden" name="goods_price" value="380000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <h3>정성한우 일품 1 구성품</h3>
        <p>구이용 등심 200g x 2팩, 차돌박이 200g x 2팩, 국거리 200g x 4팩, 총 1.6kg</p>
        <div class="detail-item">
        <h4>구이용 등심</h4> <img src="../../image/정성한우 일품 구이용 등심.jpg" alt="구이용 등심">
