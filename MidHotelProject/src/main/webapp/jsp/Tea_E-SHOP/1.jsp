...
.detail-item img {
    ...
    <body>
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
         ...
         <img src="../../image/신라 유기농 세작.jpg" alt="신라 유기농 세작">
          </div>
        <div class="product-info">
            <h1>유기농 세작</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">200,000원</span></p>
                <p>구성 : 세작 20g x 6팩 총 120g</p>
                <p>원산지 : 국내산</p>
            ...
            <div class="total"> 총 금액: <span class="total-price" id="total-price">200,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo021"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="유기농 세작"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>유기농 세작</h3>
        <br>
        <p>곡우와 입하 사이,유기농 차나무에서 딴 새 잎으로 만든 차입니다.</p>
        <p>엄격한 선별 과정을 거쳐 전통 제다법으로 만든 고급 수제차로 탄닌이 적고 아미노산 함유량이 높습니다.</p>
        <br>
        ...
        <h2>마시는 방법</h2>
        <br>
        <p>1인 기준 약 2g의 찻잎을 70~80°C 정도(찻잔을 손에 쥐었을 때 따끈한 수준)의 물에 2~5분 우려내어 드십시오.</p>
        <p>※어린순으로 만든 고급차일수록 제맛을 내려면 낮은 온도의 물에서 우려내는 것이 좋습니다.</p>
        <p>찻잎이 너무 적으면 싱거우며 너무 많을 경우 쓰고 떫은맛이 강해집니다.</p>
        <br>
        <p>생선류의 식사 또는 초콜릿, 떡 등의 디저트와 페어링 하면</p>
        <p>녹차의 향과 깊은 맛을 색다르게 즐길 수 있습니다.</p>
        <br>
</div>
</div>
<script>
