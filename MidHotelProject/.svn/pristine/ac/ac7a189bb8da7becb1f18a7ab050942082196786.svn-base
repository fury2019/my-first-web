...
.detail-item img {
     ...
     <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl003"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="센터피스 2. Coral Pink"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>센터피스 2. Coral Pink</h3>
        <br>
        <p>꽃 구성 | 장미,카네이션,그린소재 및 기타</p>
        <p>화기 규격 | 20cm(w) x 20cm(d) x 18.5cm(h)</p>
        <br>
        ...
        <img src="../../image/2. Coral Pink.JPG" alt="2. Coral Pink">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
