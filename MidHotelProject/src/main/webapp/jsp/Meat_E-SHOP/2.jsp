...
.detail-item p {
    ...
    <body>
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>청정한우 엄선</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">450,000원</span></p>
                <p>구성 : 1등급, 구이용 등심 250g x 2팩, 국거리 250g x 2팩, 불고기 250g x 4팩 총 2kg 8팩</p>
                <p>원산지 : 국내산 한우 100%</p>
                <p>배송비 : 서울 & 경기지역 무료, 경기 외곽지역 및 지방 별도 비용 (이용안내 참조)</p>
            </div>
           <div class="quantity">
                                <label for="quantity">수량:</label>
                                <input type="number" id="quantity" name="goods_amt" value="1" min="1"
                                    onchange="updateTotal()">
                            </div>
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">450,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo002"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="청정한우 엄선"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_price" value="450000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <h3>청정한우 엄선 구성품</h3>
        <p>1등급 구이용 등심 x 2팩, 국거리 x 2팩, 불고기 x 4팩 총 2kg</p>
