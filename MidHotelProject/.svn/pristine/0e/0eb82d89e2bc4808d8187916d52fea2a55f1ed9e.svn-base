...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Ls010"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="타월 세트"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>타월 세트</h3>
        <br>
        <p>배스타월 2개, 페이스타월 5개, 핸드타월 8개</p>
        <p>타월은 수분 흡수력이 뛰어나고 건조에 최적화되어 산뜻하게 이용할 수 있습니다.</p>
        <br>
        <br>
        <div class="detail-item">
        <img src="../../image/타월.JPG" alt="타월">
    </div>
</div>
