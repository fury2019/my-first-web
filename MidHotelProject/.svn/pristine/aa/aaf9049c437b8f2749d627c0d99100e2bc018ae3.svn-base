...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            ...
            <div class="product-info">
                ...
                <input type="hidden" name="goods_id" value="Fl001"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="센터피스 1. Coral Pink"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <div class="detail-item">
            <img src="../../image/1. Coral Pink.JPG" alt="1. Coral Pink">
            <div class="product-details">
                <h2>※관리방법</h2>
                <br>
