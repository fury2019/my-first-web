...
.detail-item img {
    ...
    <body>
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>민어 굴비 1</h1> <button class="heart-button" id="heart-button" onclick="toggleHeart()">❤️</button>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">250,000원</span></p>
                <p>구성 : 33cm 이상 8미, 총 2.4kg</p>
                <p>원산지 : 국내산</p>
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fo014"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="민어 굴비 1"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>민어 굴비 1호</h3>
        <br>
        <p>33cm 이상의 굴비를 선별하여 총 2.4kg의 신선한 굴비를 제공합니다.</p>
