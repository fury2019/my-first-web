...
.detail-item img {
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fo013"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="명품 굴비 5호"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>명품 굴비 5호</h3>
        <br>
        <p>20cm 이상의 굴비를 선별하여 총 1kg의 신선한 굴비를 제공합니다.</p>
        ...
        <img src="../../image/명품 굴비 5호.JPG" alt="명품 굴비 5호">
    </div>
</div>
</div>
<script>
