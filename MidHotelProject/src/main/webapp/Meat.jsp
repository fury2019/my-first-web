...
<body>
    ...
    <div class="container">
        <div class="category-header">
            <img src="image/한우.jpg" alt="한우" style="width: 100%; height: auto; border-radius: 5px;">
            <h2 class="category-title">한우 (6)</h2>
        </div>
    
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
        	<a href="../jsp/Meat_E-SHOP/1.jsp">
                <img src="image/정성한우 일품 1.jpg" alt="정성한우 일품 1">
                <div class="product-name">정성한우 일품 1</div>
                <div class="product-price">380,000원</div>
            	</a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Meat_E-SHOP/2.jsp">
                <img src="image/청정한우 엄선.jpg" alt="청정한우 엄선">
                <div class="product-name">청정한우 엄선</div>
                <div class="product-price">450,000원</div>
            </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Meat_E-SHOP/3.jsp">
                <img src="image/청정한우 특선1.jpg" alt="청정한우 특선 1">
                <div class="product-name">청정한우 특선 1</div>
                <div class="product-price">600,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Meat_E-SHOP/4.jsp">
                <img src="image/정성한우 명품 1.jpg" alt="정성한우 명품 1">
                <div class="product-name">정성한우 명품 1</div>
                <div class="product-price">630,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Meat_E-SHOP/5.jsp">
                <img src="image/정성한우 명품 2.jpg" alt="정성한우 명품 2">
                <div class="product-name">정성한우 명품 2</div>
                <div class="product-price">650,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Meat_E-SHOP/6.jsp">
                <img src="image/정성한우 명품 3.jpg" alt="정성한우 명품 3">
                <div class="product-name">정성한우 명품 3</div>
