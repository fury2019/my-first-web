...
<form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl013"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="동양란 일향금"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <br>
        <p>일향금은 자연스럽게 휘어진 곡서과 노란빛이 도는 가장자리의 테두리(복륜)를 지녀 관상가치가 높다고 알려진 품종입니다.</p>
        <br>
        <div class="detail-item">
        <img src="../../image/동양 일향금.JPG" alt="동양란 일향금">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
