...
<head>
    ...
    <title>DRAPPIER, CARTE DOR BRUT NV</title>
...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            ...
            <div class="product-info">
                <h1>DRAPPIER, CARTE DOR BRUT NV</h1>
                <div class="details">
                    <p>판매가 : <span class="price" id="unit-price">150,000원</span></p>
                    <p>방문수령지 : 서울특별시 중구 동호로15길 8, 리오베 2층</p>
                    <p>구매제한 : 만 19세 이하는 구매가 불가능합니다.</p>
                </div>
                <div class="quantity">
                    <label for="quantity">수량:</label>
                    <input type="number" id="quantity" name="goods_amt" value="1" min="1" onchange="updateTotal()">
                </div>
                <div class="total"> 총 금액: <span class="total-price" id="total-price">150,000원</span> </div>
                <input type="hidden" name="goods_id" value="Dr003"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="DRAPPIER, CARTE DOR BRUT NV"> <!-- 상품 이름 추가 -->
                <input type="hidden" name="goods_price" value="150000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>샴페인 드라피에,까르또 도르 브뤼 NV</h3>
        <br>
        <p>원산지  | France / Champagne</p>
        <p>품종  | 80% Pinot Noir, 15% Chardonnay, 5% Pinot Meunier</p>
        <p>등급 | Champagne AOC(AOP)</p>
        <p>알콜율 | 12%</p>
        <p>음용온도 | 6 ~ 8℃</p>
        <p>추천음식 | 닭고기 요리, 치즈, 흰살 생선요리 등과 잘 어울립니다.</p>
        <br>
        <p>투명하고 밝은 레몬색 컬러를 띤 샴페인입니다. </p>
        <p>레몬, 라임, 오렌지, 견과류와 빵 내음의 풍미, 모과의 달콤한 나이오사가 느껴지며 풍부한 미네랄리티,</p>
        <p>조밀한 기포와 산도, 바디 등이 전체적으로 뛰어난 밸런스를 보여줍니다.</p>
        <br>
        <div class="detail-item">
            <img src="../../image/상세 와인.JPG" alt="상세 와인">
        </div>
    </div>

    <script>
        const unitPrice = 150000; // 단가
