...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            ...
            <div class="product-info">
                ...
                <input type="hidden" name="goods_id" value="Fl019"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="서양란 2. Light Pink"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>서양란 2. Light Pink</h3>
        <br>
        <p>꽃 구성 | 호접난 9대</p>
        <p>화기 규격 | 39cm(w) x 39cm(d) x 39cm(h)</p>
        <br>
