...
.detail-item img {
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
           ...
           <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fo017"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="민어 굴비 3"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>민어 굴비 3호</h3>
        <br>
        <p>33cm 이상의 굴비를 선별하여 총 3.6kg의 신선한 굴비를 제공합니다.</p>
