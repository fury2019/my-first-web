...
.detail-item p {
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <div class="details">
                ...
                <p>구성 : 1+등급, 구이용 등심 250g x 2팩, 채끝 250g x 2팩, 부채 250g x 2팩, 국거리 250g x 2팩, 총 2kg 8팩</p>
                <p>원산지 : 국내산 한우 100%</p>
                <p>배송비 : 서울 & 경기지역 무료, 경기 외곽지역 및 지방 별도 비용 (이용안내 참조)</p>
            		...
            		<div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fo003"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="청정한우 특선 1"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <h3>청정한우 특선 1 구성품</h3>
        <p>구이용 등심 250g x 2팩, 채끝 250g x 2팩, 부채살 250g x 2팩, 국거리 250g x 2팩 총 2kg</p>
    ...
    <div class="detail-item">
     ...
     <div class="detail-item">
        <h4>국거리</h4> <img src="../../image/정성한우 일품 국거리.jpg" alt="국거리">
        <p>부드러운 살코기와 적당한 지방 함량으로 오랜 시간 푹 끓이면</p>
        <p>고소한 풍미가 진하게 우러나오는 부위를 담았습니다.</p>
        <p>원하는 크기로 잘라 조리해 드실 수 있도록 덩어리째 준비하였습니다.</p>
    </div>
</div>
