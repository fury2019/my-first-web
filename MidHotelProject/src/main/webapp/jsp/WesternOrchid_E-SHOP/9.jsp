...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            ...
            <div class="product-info">
                ...
                <input type="hidden" name="goods_id" value="Fl023"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="서양란 3. White"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <div class="detail-item">
            <img src="../../image/서양란 White.JPG" alt="서양란 White">
            <div class="product-details">
                <h2>※관리방법</h2>
                <br>
