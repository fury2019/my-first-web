...
.detail-item p {
    ...
    <body>
        ...
        <div class="product-info">
            <h1>정성한우 명품 1</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">630,000원</span></p>
                <p>구성 : 1+등급 한우, 구이용 등심 250g x 2팩, 채끝 250g x 2팩, 부채살 250g x 2팩, 불고기 250g x 2팩 총 8팩 2kg</p>
                <p>원산지 : 국내산 한우 100%</p>
            ...
            <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">630,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo004"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="정성한우 명품 1"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="630000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <h3>정성한우 명품 1 구성품</h3>
        <p>구이용 등심 250g, 채끝 250g, 부채살 250g, 불고기 250g x 각 2팩 총 2kg(250g씩 스킨포장)</p>
