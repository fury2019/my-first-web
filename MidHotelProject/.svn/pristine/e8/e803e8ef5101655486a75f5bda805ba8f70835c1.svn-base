...
.detail-item img {
     ...
     <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
           ...
           <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl012"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="동양란 금황"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <br>
        <p>금황은 향이 좋고 자태가 멋스러우며 부드럽게 늘어지는 앞면에 무늬가 있는 품종입니다.</p>
        <br>
        <div class="detail-item">
        <img src="../../image/동양 금황.JPG" alt="동양란 금황">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
