...
<div class="header">
    ...
    <div class="container">
        <div class="category-header">
            <img src="../image/리빙.jpg" alt="리빙" style="width: 100%; height: auto; border-radius: 5px;">
            <h2 class="category-title">리빙 (3)</h2>
        </div>
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Living_E-SHOP/1.jsp">
                <img src="../image/주안상 자기.jpg" alt="주안상 자기">
                <div class="product-name">주안상 자기</div>
                <div class="product-price">180,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Living_E-SHOP/2.jsp">
                <img src="../image/전통 후식기 자기.jpg" alt="전통 후식기 자기">
                <div class="product-name">전통 후식기 자기</div>
                <div class="product-price">250,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/Living_E-SHOP/3.jsp">
                <img src="../image/달항아리.jpg" alt="달항아리">
                <div class="product-name">달항아리</div>
