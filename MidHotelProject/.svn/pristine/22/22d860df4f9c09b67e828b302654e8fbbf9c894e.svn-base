...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            ...
            <div class="product-info">
                <h1>서양란 3. Light Pink</h1>
                <div class="details">
                    <p>판매가 : <span class="price" id="unit-price">500,000원</span></p>
                    <p>구성 : 호접란 15대</p>
                ...
                <div class="total"> 총 금액: <span class="total-price" id="total-price">500,000원</span> </div>
                <input type="hidden" name="goods_id" value="Fl022"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="서양란 3. Light Pink"> <!-- 상품 이름 추가 -->
                <input type="hidden" name="goods_price" value="500000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>서양란 3. Light Pink</h3>
        <br>
        <p>꽃 구성 | 호접난 15대</p>
        <p>화기 규격 | 55cm(w) x 55cm(d) x 22cm(h)</p>
        <br>
        <p>호접난은 꽃이 매우 아름다우며 오래도록 즐길 수 있어 선물용으로 좋습니다.</p>
        <p>좋은 의미를 담은 꽃말로 받는 분에게 만족스러운 선물이 될 것입니다.</p>
        <br>
        <div class="detail-item">
            <img src="../../image/서양란 Light Pink.JPG" alt="서양란 Light Pink">
            <div class="product-details">
                <h2>※관리방법</h2>
                <br>
                <p>- 난을 건강하고 아름다운 상태로 유지하기 위해서는 난의 종류를 이해하고 적절하게 관리해야 합니다.</p>
                <p>- 물은 표면이 촉촉해질 정도로 주는 것이 좋습니다.</p>
                <p>- 난은 습도가 낮은 곳에 둔 경우, 스프레이로 자주 물을 뿌려주고 꽃에는 직접 물을 뿌리지 않도록 주의합니다.</p>
                <p>- 고온 작업으로 20~30도의 적정 온도를 유지하는 것이 좋습니다.</p>
                <p>- 직광선은 피해 이기 또는 잘 되는 곳에 두시길 권장합니다.</p>
                <p>- 습한 환경을 위해 이기 또는 잘게 자른 나무 등을 넣어 키우는 것이 좋습니다.</p>
                <p>- 꽃이 핀 후에는 2주에 1회 정도 비료를 주는 것이 좋으며 꽃이 떨어진 후에는 비료를 주지 않습니다.</p>
                <br>
            </div>
        </div>
    </div>
