 ...
 <div class="header">
    ...
    <div class="container">
        <div class="category-header">
            <img src="image/수산.jpg" alt="수산" style="width: 100%; height: auto; border-radius: 5px;">
            <h2 class="category-title">수산 (8)</h2>
        </div>
    
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Seafood_E-SHOP/1.jsp">
                <img src="image/명품 굴비.jpg" alt="명품 굴비 5호">
                <div class="product-name">명품 굴비 5호</div>
                <div class="product-price">200,000원</div>
            	</a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Seafood_E-SHOP/2.jsp">
                <img src="image/민어 굴비.jpg" alt="민어 굴비 1">
                <div class="product-name">민어 굴비 1</div>
                <div class="product-price">250,000원</div>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Seafood_E-SHOP/3.jsp">
                <img src="image/명품 굴비.jpg" alt="명품 굴비 4호">
                <div class="product-name">명품 굴비 4호</div>
                <div class="product-price">280,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Seafood_E-SHOP/4.jsp">
                <img src="image/민어 굴비.jpg" alt="민어 굴비 2">
                <div class="product-name">민어 굴비 2</div>
                <div class="product-price">300,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Seafood_E-SHOP/5.jsp">
                <img src="image/민어 굴비.jpg" alt="민어 굴비 3">
                <div class="product-name">민어 굴비 3</div>
                <div class="product-price">350,000원</div>
                </a>
            </div>
             <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
             	<a href="/jsp/Seafood_E-SHOP/6.jsp">
                <img src="image/명품 굴비.jpg" alt="명품 굴비 3호">
                <div class="product-name">명품 굴비 3호</div>
                <div class="product-price">390,000원</div>
                </a>
            </div>
              <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
              	<a href="/jsp/Seafood_E-SHOP/7.jsp">
                <img src="image/명품 굴비.jpg" alt="명품 굴비 2호">
                <div class="product-name">명품 굴비 2호</div>
                <div class="product-price">620,000원</div>
                </a>
            </div>
             <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
             	<a href="/jsp/Seafood_E-SHOP/8.jsp">
                <img src="image/명품 굴비.jpg" alt="명품 굴비 1호">
                <div class="product-name">명품 굴비 1호</div>
                <div class="product-price">1,350,000원</div>
                </a>
            </div>
        </div>
    </div>
