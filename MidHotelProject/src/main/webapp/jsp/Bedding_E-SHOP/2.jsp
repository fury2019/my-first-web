...
.detail-item img {
 ...
 <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>베딩 세트_Q</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">1,400,000원</span></p>
                <p>구성 : 구스다운 이불(Q) 1, 이불커버(Q) 1, 매트리스커버(Q) 1, 베드패드(Q) 1</p>
             ...
             <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">1,400,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Ls002"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="베딩 세트_Q"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="1400000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <img src="../../image/상세 베딩 세트_Q.JPG" alt="베딩 세트_Q">
    </div>
</div>

<script>
    const unitPrice = 1400000; // 단가
