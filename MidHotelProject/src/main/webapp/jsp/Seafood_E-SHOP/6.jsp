...
.detail-item img {
    ...
    <body>
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>명품 굴비 3호</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">390,000원</span></p>
                <p>구성 : 23cm 이상 10미, 총 1.4kg</p>
                <p>원산지 : 국내산</p>
            ...
            <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">390,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo018"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="명품 굴비 3호"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="390000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>명품 굴비 3호</h3>
        <br>
        <p>23cm 이상의 굴비를 선별하여 총 1.4kg의 신선한 굴비를 제공합니다.</p>
        ...
        <img src="../../image/명품 굴비 3호.JPG" alt="명품 굴비 3호">
    </div>
</div>
</div>
<script>
    const unitPrice = 390000; // 단가
