...
<head>
    ...
    <title>JEAN JACQUES GIRARD 2021</title>
...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            ...
            <div class="product-info">
                <h1>JEAN JACQUES GIRARD 2021</h1>
                <div class="details">
                    <p>판매가 : <span class="price" id="unit-price">100,000원</span></p>
                ...
                <div class="total"> 총 금액: <span class="total-price" id="total-price">100,000원</span> </div>
                <input type="hidden" name="goods_id" value="Dr002"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="JEAN JACQUES GIRARD 2021"> <!-- 상품 이름 추가 -->
                <input type="hidden" name="goods_price" value="100000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>도멘 장 자크 지라드 사비니 레 본</h3>
        <br>
        <p>원산지  | France / Bourgogne / Savigny-les-Beaune</p>
        <p>품종  | Pinot Noir</p>
        <p>등급 | Vilage</p>
        <p>알콜율 | 13.5 %</p>
        <p>음용온도 | 14 ~ 16℃</p>
        <p>추천음식 | 견과류와 함께 구워낸 브릭치즈,제육볶음 등과 잘 어울립니다.</p>
        <br>
        <p>신선한 흙 향 내음,체리,라즈베리,검붉은 과실 뉘앙스가 먼저 다가오며 이후 감초 향이 은은하게 올라옵니다.</p>
        <p>실키한 질감의 탄닌과 산도,그리고 볼륨감 넘치는 바디감의 밸런스가 조화로우며 피니시가 길게 남는 것이 특징입니다.</p>
        <br>
