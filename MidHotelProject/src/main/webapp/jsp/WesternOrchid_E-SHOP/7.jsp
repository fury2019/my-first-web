...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            <div class="product-image">
                <img src="../../image/서양란 3. Dark Pink.jpg" alt="서양란 1. Dark Pink">
            </div>
            <div class="product-info">
                <h1>서양란 3. Dark Pink</h1>
                <div class="details">
                ...
                <input type="hidden" name="goods_id" value="Fl021"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="서양란 3. Dark Pink"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <div class="detail-item">
            <img src="../../image/서양란 Dark Pink.JPG" alt="서양란 Dark Pink">
            <div class="product-details">
                <h2>※관리방법</h2>
                <br>
