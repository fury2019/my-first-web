 ...
 <div class="header">
    ...
    <div class="container">
        <div class="category-header">
            <img src="../image/꽃바구니.jpg" alt="꽃바구니" style="width: 100%; height: auto; border-radius: 5px;">
            <h2 class="category-title">꽃바구니 (4)</h2>
        </div>
    
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/FlowerBasket_E-SHOP/1.jsp">
                <img src="../image/꽃바구니 2. Coral Pink.jpg" alt="꽃바구니 2. Coral Pink">
                <div class="product-name">꽃바구니 2. Coral Pink</div>
                <div class="product-price">300,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/FlowerBasket_E-SHOP/2.jsp">
                <img src="../image/꽃바구니 2. White & Green.jpg" alt="꽃바구니 2. White & Green">
                <div class="product-name">꽃바구니 2. White & Green</div>
                <div class="product-price">300,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/FlowerBasket_E-SHOP/3.jsp">
                <img src="../image/꽃바구니 3. Coral Pink.jpg" alt="꽃바구니 3. Coral Pink">
                <div class="product-name">꽃바구니 3. Coral Pink</div>
                <div class="product-price">500,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 75px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="../jsp/FlowerBasket_E-SHOP/4.jsp">
                <img src="../image/꽃바구니 3. White & Green.jpg" alt="꽃바구니 3. White & Green">
                <div class="product-name">꽃바구니 3. White & Green</div>
                <div class="product-price">500,000원</div>
                </a>
            </div>
        </div>
