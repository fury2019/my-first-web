...
.detail-item img {
 ...
 <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="details">
             ...
             <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Ls014"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value=전통 후식기 자기"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>전통 후식기 자기</h3>
        <br>
        <h4>전통 후식기는 수정과,식혜 등 전통음료나 궁중병과,제철 과일 등을 담아내기 좋습니다.</h4>
        <p>조선백자를 현대적인 볼의 형태로 재해석한 자기로 식사의 마지막까지 품격을 더해 보시기 바랍니다.</p>
        <br>
        <br>
        <div class="detail-item">
        <img src="../../image/상세 전통 후식기 자기.JPG" alt="전통 후식기 자기">
    </div>
</div>
