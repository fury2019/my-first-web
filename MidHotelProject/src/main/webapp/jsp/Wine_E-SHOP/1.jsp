...
<head>
    ...
    <title>GEORGES GLANTENAY BOURGOGNE 21</title>
...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        <div class="product-section">
            ...
            <div class="product-info">
                <h1>GEORGES GLANTENAY BOURGOGNE 21</h1>
                <div class="details">
                ...
                <input type="hidden" name="goods_id" value="Dr001"> <!-- 상품 ID 추가 -->
                <input type="hidden" name="goods_name" value="GEORGES GLANTENAY BOURGOGNE 21"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <br>
        <h3>도멘 조르주 글란트네 부르고뉴(메종 듀)</h3>
        <br>
        <p>원산지  | France / Bourgogne</p>
        <p>품종  | Pinot Noir</p>
        <p>등급 | Regionale</p>
        <p>알콜율 | 12.5 %</p>
        <p>음용온도 | 14 ~ 16℃</p>
        <p>추천음식 | 살라미 샌드위치, 칠면조 고기와 잘 어울립니다.</p>
        <br>
        <p>밝은 루비 색상 와인으로 불룩함이 있는 자두 향부터 달기, 제비꽃, 홀, 오크 삼나무 등 다채로운 향이 느껴집니다.</p>
        <p>부드러운 탄닌이 입안을 감싸며 시간이 지날수록 우아한 품미를 전하는 매력적인 와인입니다.</p>
        <br>
