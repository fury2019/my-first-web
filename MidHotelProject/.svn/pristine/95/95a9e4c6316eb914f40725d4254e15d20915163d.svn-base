...
.detail-item p {
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="details">
                ...
                <p>구성 : 실 중량 7.91kg_총 12과_머스크 멜론 2, 사과 2, 샤인머스캣 3, 애플 망고 3, 로얄망고 2</p>
                <p>원산지 : 상세설명 참고</p>
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fo011"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="과일 혼합 5호"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <h3>과일 혼합 5호 구성품</h3>
        <p>머스크 멜론 1.6kg x 2, 사과 380g x 2, 샤인머스켓 600g x 3, 애플 망고 450g x 3, 로얄 망고 400g x 2 실 중량 7.91kg</p>
