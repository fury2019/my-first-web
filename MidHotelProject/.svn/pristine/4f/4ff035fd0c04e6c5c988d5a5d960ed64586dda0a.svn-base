...
.detail-item img {
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
           ...
           <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Fl014"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="동양란 황금일향금"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <br>
        <p>황금일향금은 일향금 중에서도 황금색 복륜(잎의 가장자리에 황색 선이 덮어 둘러진 무늬)이 특히 발현되었으며</p>
        <p>가장 고급스러운 동양란 품종으로 알려져 있습니다.</p>
        <p>앞 무늬를 통해 품격을 드러내며 관상 가치가 뛰어납니다.</p>
        <br>
        <div class="detail-item">
        <img src="../../image/동양 황금일향금.JPG" alt="동양란 황금일향금">
         <div class="product-details">
        <h2>※관리방법</h2>
        <br>
