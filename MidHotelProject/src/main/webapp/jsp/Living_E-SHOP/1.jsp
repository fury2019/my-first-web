...
<body>
    ...
    <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
         ...
         <img src="../../image/주안상 자기.jpg" alt="주안상 자기">
          </div>
        <div class="product-info">
            <h1>주안상 자기</h1> 
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">180,000원</span></p>
                <p>구성 : 술병 1개, 잔 2개, 접시 1개</p>
            ...
            <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">180,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Ls013"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="주안상 자기"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="180000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>주안상 자기</h3>
        <br>
        <p>주안상 자기는 간단한 안주를 올릴 수 있는 접시와 전통주의 품격을 더해줄 술병,그리고 잔으로 구성하였습니다.</p>
        <p>세련되고 단정한 주안상 세트로 기품 있는 술상을 즐겨 보시기 바랍니다.</p>
        <br>
        <br>
        <div class="detail-item">
        <img src="../../image/상세 주안상 자기.JPG" alt="상세 주안상 자기">
    </div>
</div>

<script>
    const unitPrice = 180000; // 단가
