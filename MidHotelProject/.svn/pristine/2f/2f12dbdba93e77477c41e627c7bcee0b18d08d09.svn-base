...
<form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
         ...
         <img src="../../image/배스로브 & 타월 세트.jpg" alt="배스로브 & 타월 세트">
          </div>
        <div class="product-info">
            <h1>배스로브 & 타월 세트</h1> 
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">600,000원</span></p>
                <p>구성 : 배스로브 2, 배스타월 2, 페이스타월 5, 핸드타월 8</p>
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Ls012"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="배스로브 & 타월 세트"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>배스로브 & 타월 세트</h3>
        <br>
        <h4>배스로브 2개, 배스타월 2개, 페이스타월 5개, 핸드타월 8개</h4>
        <p>배스로브와 타월은 수분 흡수력이 뛰어나고 건조에 최적화되어 산뜻하게 이용할 수 있습니다.</p>
        <br>
        <br>
        <div class="detail-item">
        <img src="../../image/상세 배스로브 & 타월 세트.JPG" alt="배스로브 & 타월 세트">
    </div>
</div>
