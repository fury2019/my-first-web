...
.detail-item img {
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="total"> 총 금액: <span class="total-price" id="total-price">300,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo023"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="유기농 발효차 1"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>유기농 발효차 1</h3>
        <br>
        <p>유기농 발효차 1은 곡우 즈음 딴 여린 잎 중에서도 좋은 찻잎으로만 엄선하여 만든 홍차입니다.</p>
