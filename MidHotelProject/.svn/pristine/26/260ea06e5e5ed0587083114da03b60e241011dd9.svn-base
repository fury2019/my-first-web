           ...
           border-radius: 5px;
            ...
            <body>
                ...
                <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
                    <div class="product-section">
                        ...
                        <div class="product-info">
                            ...
                            <input type="hidden" name="goods_id" value="Fl016"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="서양란 1. Light Pink"> <!-- 상품 이름 추가 -->
                ...
                <div class="product-details">
                    <h2>상품 상세</h2>
                    <br>
                    <h3>서양란 1. Light Pink</h3>
                    <br>
                    <p>꽃 구성 | 호접난 6대</p>
                    <p>화기 규격 | 35cm(w) x 35cm(d) x 35cm(h)</p>
                    <br>
