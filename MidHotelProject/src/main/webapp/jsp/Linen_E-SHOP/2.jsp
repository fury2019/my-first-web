...
.detail-item img {
 ...
 <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="details">
             ...
             <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Ls011"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="배스로브 세트"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <br>
        <h4>배스로브 2개</h4>
        <p>배스로브은 수분 흡수력이 뛰어나고 건조에 최적화되어 산뜻하게 이용할 수 있습니다.</p>
        <br>
        <br>
        <div class="detail-item">
        <img src="../../image/배스로브.JPG" alt="배스로브">
    </div>
</div>
