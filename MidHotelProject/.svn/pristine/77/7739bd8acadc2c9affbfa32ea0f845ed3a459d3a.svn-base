...
.detail-item img {
    ...
    <body>
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
         ...
         <img src="../../image/명품 굴비.jpg" alt="명품 굴비">
          </div>
        <div class="product-info">
            <h1>명품 굴비 1호</h1> 
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">1,350,000원</span></p>
                <p>구성 : 27cm 이상 10미, 총 2.4kg</p>
                <p>원산지 : 국내산</p>
            ...
            <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">1,350,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo020"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="명품 굴비 1호"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="1350000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>명품 굴비 1호</h3>
        <br>
        <p>27cm 이상의 굴비를 선별하여 총 2.4kg의 신선한 굴비를 제공합니다.</p>
        <p>산지에서 조기를 엄선하고 고유의 섶장법을 지켜 전 과정을 직접 관리하였습니다.</p>
        <br>
        <h3>특정 시기에 어획한 국내산 참조기</h3>
        <br>
        <p>참조기의 살이 차오르고 육질이 쫄깃해지는 11월 ~ 1월 중 제주 인근 해역에서 어획한 국내산 참조기만 사용합니다.</p>
        <br>
        ...
        <br>
        <p>국내산 참조기 수매부터 선별,섶간,엮기,세척,건조,급랭까지 상품화하는 모든 과정에 직접 참여하여 품질을 철저히 관리합니다.</p>
        <br>
        <div class="detail-item">
        <img src="../../image/명품 굴비 1호.JPG" alt="명품 굴비 1호">
    </div>
</div>
</div>
<script>
    const unitPrice = 1350000; // 단가
