...
.detail-item img {
    ...
    <body>
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>수복강녕 진액 2</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">350,000원</span></p>
                <p>구성 : 진액 꿀차 480g, (160g×3개)</p>
                <p>원산지 : 국내산</p>
            ...
            <div class="total"> 총 금액: <span class="total-price" id="total-price">350,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo024"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="수복강녕 진액 2"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="350000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>수복 강녕 진액2</h3>
        <br>
        <p>벌꿀,녹용,당귀,산수유,인삼,생지황,복령,울금,매실,</p>
        <p>총 9가지의 엄선한 재료를 정성스럽게 조합하여 만들었습니다.</p>
        <br>
        <div class="detail-item">
        <img src="../../image/수복강녕 진액 샵 1.JPG" alt="수복강녕 진액 샵 1">
    	</div>
    	<div class="product-details">
        <br>
        <p>벌꿀이 들어있어 달콤하며 몸에 좋은 다양한 재료들이 어우러져 진한 향과 깊은 맛을 전합니다.</p>
        <p>진액으로 되어 있어 그대로 떠드시거나 차 대용으로 마시기 좋습니다.</p>
        <br>
</div>
</div>
<script>
    const unitPrice = 350000; // 단가
