...
.detail-item p {
    ...
    <body>
      ...
      <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            <h1>과일 혼합 6호</h1> 
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">400,000원</span></p>
                <p>구성 : 실 중량 8.96kg_총 14과_머스크 멜론 2, 사과 2, 샤인머스캣 4, 애플 망고 4, 로얄망고 2</p>
                <p>원산지 : 상세설명 참고</p>
           ...
           <div class="quantity">
                            ...
                            <div class="total"> 총 금액: <span class="total-price" id="total-price">400,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo012"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="과일 혼합 6호"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="400000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        <h2>상품 상세</h2>
        <h3>과일 혼합 6호 구성품</h3>
        <p>머스크 멜론 1.6kg x 2, 사과 380g x 2, 샤인머스켓 600g x 4, 애플 망고 450g x 4, 로얄 망고 400g x 2 실 중량 8.96kg</p>
