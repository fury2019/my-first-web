...
.detail-item img {
    ...
    <body>
       ...
       <form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
         ...
         <img src="../../image/신라 유기농 발효차 2.jpg" alt="신라 유기농 발효차 2">
          </div>
        <div class="product-info">
            <h1>유기농 발효차 2</h1>
            <div class="details">
                <p>판매가 : <span class="price" id="unit-price">600,000원</span></p>
                <p>구성 : 특 우전차 20g x 6팩 총 120g</p>
                <p>원산지 : 국내산</p>
            ...
            <div class="total"> 총 금액: <span class="total-price" id="total-price">600,000원</span> </div>
                            <input type="hidden" name="goods_id" value="Fo026"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="유기농 발효차 2"> <!-- 상품 이름 추가 -->
                            <input type="hidden" name="goods_price" value="600000"> <!-- 가격 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>유기농 발효차 2</h3>
        <br>
        <p>유기농 발효차 2는 곡우 전에 딴 여린 잎 중에서도 좋은 찻잎으로만 엄선하여 만든 홍차입니다.</p>
        <p>저온 발효와 숙성을 거쳐 만들어진 차로 바디감과 향이 돋보입니다.</p>
        <br>
        <div class="detail-item">
        <img src="../../image/신라 유기농 발효차 1.jpg" alt="신라 유기농 발효차 1">
    	</div>
    	<div class="product-details">
        <h2>마시는 방법</h2>
        <br>
        <p>1인 기준 약 2g의 찻잎을 98°C정도(찻잔을 손에 쥐었을 때 따끈한 수준)의 물에 2~5분 우려내어 드십시오.</p>
        <br>
        <p>꽃과 과일이 어우러진 깔끔하고 부드러운 단맛으로 꽃,포도,사과,꿀 향을 전합니다.</p>
        <p>밀크티로 즐기실 경우 더욱 다채로운 차의 풍미를 느낄 수 있습니다.</p>
        <br>
</div>
</div>
<script>
    const unitPrice = 600000; // 단가
