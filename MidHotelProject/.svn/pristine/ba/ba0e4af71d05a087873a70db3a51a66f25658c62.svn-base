...
<form action="${pageContext.request.contextPath}/goods_CartInsert" method="post">
        ...
        <div class="product-info">
            ...
            <div class="quantity">
                            ...
                            <input type="hidden" name="goods_id" value="Ls015"> <!-- 상품 ID 추가 -->
                            <input type="hidden" name="goods_name" value="달항아리"> <!-- 상품 이름 추가 -->
    ...
    <div class="product-details">
        ...
        <h3>달항아리</h3>
        <br>
        <p>대표적인 조선백자인 달향아리를 현대적 조형미로 재해석하여 세련되게 선보인 작품입니다.</p>
        <p>달덩이처럼 둥글고 원만한 모습을 지닌 달향아리로 불리며, 보름달처럼 넉넉하고 풍요한 느낌을 전달합니다.</p>
        <p>균형 잡힌 은은한 광택이 매력적이어 화병으로 사용하거나, 상공간의 마음을 담은 인테리어 오브제로도 활용하기 좋습니다.</p>
        <br>
        <br>
        <div class="detail-item">
        <img src="../../image/상세 달항아리.JPG" alt="달항아리">
    </div>
</div>
