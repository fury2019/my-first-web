   ...
   <div class="sub-nav">
    ...
    <div class="container">
        <div class="category-header">
            <img src="/image/과일,차.jpg" alt="과일,차" style="width: 100%; height: auto; border-radius: 5px;">
            <h2 class="category-title">차 (6)</h2>
        </div>
    
        <div class="row justify-content-center"> <!-- 중앙 정렬 -->
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Tea_E-SHOP/1.jsp">
                <img src="/image/신라 유기농 세작.jpg" alt="DDIT 유기농 세작">
                <div class="product-name">유기농 세작</div>
                <div class="product-price">200,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Tea_E-SHOP/2.jsp">
                <img src="/image/수복강녕 진액 2.jpg" alt="수복강녕 진액 1">
                <div class="product-name">수복강녕 진액 1</div>
                <div class="product-price">250,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Tea_E-SHOP/3.jsp">
                <img src="/image/신라 유기농 발효차 1.jpg" alt="DDIT 유기농 발효차 1">
                <div class="product-name">유기농 발효차 1</div>
                <div class="product-price">300,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Tea_E-SHOP/4.jsp">
                <img src="/image/수복강녕 진액 2.jpg" alt="수복강녕 진액 2">
                <div class="product-name">수복강녕 진액 2</div>
                <div class="product-price">350,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Tea_E-SHOP/5.jsp">
                <img src="/image/신라 유기농 명차.jpg" alt="DDIT 유기농 명차">
                <div class="product-name">유기농 명차</div>
                <div class="product-price">600,000원</div>
                </a>
            </div>
            <div class="col-md-3 product" style="margin: 0 55px 30px;"> <!-- 아래쪽 여백 추가 -->
            	<a href="/jsp/Tea_E-SHOP/6.jsp">
                <img src="/image/신라 유기농 발효차 2.jpg" alt="DDIT 유기농 발효차 2">
                <div class="product-name">유기농 발효차 2</div>
                <div class="product-price">600,000원</div>
                </a>
            </div>
        </div>
